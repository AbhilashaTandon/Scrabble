...
run: CXXFLAGS := -O2 $(COMMON_FLAGS) $(CPPFLAGS)
compile: CXXFLAGS := -O2 $(COMMON_FLAGS) $(CPPFLAGS)
lint: CXXFLAGS := -O0 $(COMMON_FLAGS) $(CPPFLAGS)
debug: CXXFLAGS := -g3 -O0 $(COMMON_FLAGS) $(CPPFLAGS)
profile: CXXFLAGS := -g -O0 $(COMMON_FLAGS) $(CPPFLAGS)
valgrind: CXXFLAGS := -g -O2 $(COMMON_FLAGS) $(CPPFLAGS)
...
debug: $(DEBUG_DIR)/$(TARGET)
	gdb --args $(DEBUG_DIR)/$(TARGET) $(TARGET_FLAGS)
